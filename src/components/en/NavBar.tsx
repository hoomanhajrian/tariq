...
const NavBar = () => {
  useEffect(() => {
    ...
    const $targetEl: HTMLElement | null = document.getElementById("triggerEl");
  ...
  return (
    <nav className=" dark:bg-blue border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          ...
          <div className="display-flex ">
            <h1 className="self-center text-4xl font-semibold whitespace-nowrap text-cream">
              Tariq Louis
            </h1>
            <h2 className="self-center text-1xl font-semibold whitespace-nowrap dark:text-purple-500">
              Iraqi Plastic Sculptor
            </h2>
          </div>
        </a>
